...
import br.com.bruno.reactiveFlashcards.domain.helper.RetryHelper;
...
public class MailService {
    ...
    public MailService(RetryHelper retryHelper,
    ...
    public Mono<Void> send(MailMessageDTO mailMessage){
    ...
    private Mono<Void> send(MimeMessage mimeMessage){
        return Mono.fromCallable(() ->{

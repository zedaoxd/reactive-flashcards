...
import br.com.bruno.reactiveFlashcards.core.DeckApiConfig;
import br.com.bruno.reactiveFlashcards.domain.dto.AuthDTO;
...
public class DeckRestQueryService {
    ...
    private Flux<DeckDTO> doGetDecks(String token){
